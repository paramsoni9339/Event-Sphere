    ...
    <WavyBackground className="max-w-md mx-auto px-4" backgroundFill="#000000" blur={5}>
      <div className="w-full rounded-lg border bg-card/80 backdrop-blur-md p-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-white/80">Sign up to start organizing and discovering events</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button className="inline-flex h-10 w-full items-center justify-center rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-700">
            Create Account
          </button>
